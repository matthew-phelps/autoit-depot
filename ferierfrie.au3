...
; How long to wait for user to input date
Local $wait_date = 4000
Local $smart_tid_panel = "SmartTid Panel"
Local $dateControl = "[CLASS:WindowsForms10.EDIT.app.0.13965fa_r6_ad1]"
